...
export default function UnderMaintenance({ primaryBtn, heading }) {
  return (
    <ContainerWrapper>
      <Stack sx={{ width: 1, height: '100vh', py: SECTION_COMMON_PY, minHeight: { xs: 450, sm: 600, md: 800 } }}>
        <GraphicsCard sx={{ width: 1, height: 1, position: 'relative', backgroundColor: 'primary.light' }}>
...
UnderMaintenance.propTypes = { primaryBtn: PropTypes.any, heading: PropTypes.string };
