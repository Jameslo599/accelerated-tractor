...
const menuItems = [
  ...
  },
  {
    ...
    caption: `All content on this website, including but not limited to text, graphics, logos, images, audio clips, video clips, digital downloads, and data compilations, is the property of ${branding.brandName} or its content suppliers and protected by international copyright laws.`
  },
  {
    id: 'privacy-policy',
  ...
  },
  {
    ...
    caption: `If you submit any material to this website, you grant ${branding.brandName} a perpetual, royalty-free, worldwide license to use, reproduce, modify, adapt, publish, translate, create derivative works from, distribute, and display such material.`
  },
  {
    id: 'limitation-of-liability',
    heading: 'Limitation of Liability',
    caption: `In no event shall ${branding.brandName} or its affiliates be liable for any direct, indirect, incidental, special, or consequential damages resulting from the use or inability to use this website.`
  },
  {
    id: 'indemnity',
    heading: 'Indemnity',
    caption: `You agree to indemnify and hold harmless ${branding.brandName} and its affiliates from any claims, actions, demands, damages, liabilities, costs, or expenses, including reasonable attorneys' fees, arising out of or related to your use of the website or any violation of these terms.`
  },
  {
    id: 'governing-law',
