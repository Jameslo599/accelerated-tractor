...
export default function palette(mode) {
  ...
  const lightPalette = {
    primary: {
      lighter: '#1340ba', // AI/primary/90 - primary container / primary fixed
    ...
    grey: {
      ...
      100: '#111f68', // dark blue
      200: '#fbfbfb', // AI/neutral/94 - surface container
      300: '#ffffff', // AI/neutral/92 - surface container high
