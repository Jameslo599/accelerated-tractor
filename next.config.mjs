...
const cspHeader = `
  ...
  img-src 'self' blob: data: https://www.googletagmanager.com https://flagcdn.com https://*.openstreetmap.org https://*.clarity.ms https://*.bing.com https://phpstack-207002-5085356.cloudwaysapps.com https://i.vimeocdn.com https://arclight.vimeo.com;
  font-src 'self' https://*.gstatic.com;
  object-src 'none';
  base-uri 'self';
  form-action 'self';
  media-src 'self' https://*.cloudfront.net https://player.vimeo.com https://arclight.vimeo.com https://vod-progressive.akamaized.net;
  frame-src https://player.vimeo.com https://arclight.vimeo.com;
